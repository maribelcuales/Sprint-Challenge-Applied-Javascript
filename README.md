...
An event are all the actions that a user does on a webpage such as clicking of a button, zooming in and out, dragging and dropping, etc.
...
Converting a NodeList into an Array gives us access to the array methods in order for us to better iterate over our data. 
